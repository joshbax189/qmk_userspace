...
[0] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, RSFT_T(KC_MINS),
...
[2] = LAYOUT(
  ...
  UG_TOGG, KC_INS,   KC_PSCR,  KC_APP,   XXXXXXX,  KC_VOLU,                        KC_PGUP, KC_HOME, KC_UP,   KC_END,   _______, _______,
